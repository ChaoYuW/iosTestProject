...
{
    // 设置camera view
    ECCameraButton *cameraButton = [[ECCameraButton alloc] initWithFrame:CGRectMake(0, 0, CAMERABUTTONWIDTH, CAMERABUTTONWIDTH)];
